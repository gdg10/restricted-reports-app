...
class ProgressButtons extends Component {
  ...
  mapReportStateToReportData(rs) {
    return {
      ...
      subjectHistory:
        rs.subject.subjectHistory + " No other prior history avaliable.",
      ...
      comp1:
        rs.comparables[0].address +
        " " +
        rs.comparables[0].address2 +
        ", " +
        rs.comparables[0].city +
        ", " +
        rs.comparables[0].state +
        ", " +
        rs.comparables[0].zip,
      ...
      comp2:
        rs.comparables[1].address +
        " " +
        rs.comparables[1].address2 +
        ", " +
        rs.comparables[1].city +
        ", " +
        rs.comparables[1].state +
        ", " +
        rs.comparables[1].zip,
      ...
      comp3:
        rs.comparables[2].address +
        " " +
        rs.comparables[2].address2 +
        ", " +
        rs.comparables[2].city +
        ", " +
        rs.comparables[2].state +
        ", " +
        rs.comparables[2].zip,
      ...
      comp4:
        rs.comparables[3].address +
        " " +
        rs.comparables[3].address2 +
        ", " +
        rs.comparables[3].city +
        ", " +
        rs.comparables[3].state +
        ", " +
        rs.comparables[3].zip,
  ...
  handlePublish = () => {
    var data = JSON.stringify(
      this.mapReportStateToReportData(this.props.reportState)
    );
    console.log(data);
      ...
      .then(res => {
        ...
        this.props.dispatch(
          addReport({
            link: res.response,
            address:
              this.props.reportState.subject.address +
              ", " +
              this.props.reportState.subject.city +
              ", " +
              this.props.reportState.subject.state +
              ", " +
              this.props.reportState.subject.zip,
            status: "Published",
